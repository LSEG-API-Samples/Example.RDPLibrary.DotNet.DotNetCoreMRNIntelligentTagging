...
{
    /// <summary>
    /// PersonEntity is a specific class represent a fields from Intelligent Tagging JSON message which contains Entity for Person metadata
    /// </summary>
    public class PersonEntity : IMetaData
    {
